import { ARROW_KILLABLE_ASPECT, ARROW_OBJECT_ASPECT } from './../ancient-maze/aspects';
import {
	ACTOR_ASPECT,
	COLLECTABLE_ASPECT,
	COLLECTOR_ASPECT,
...
import { KILL_ON_OVERLAP_OBJECT_ASPECT } from '../ancient-maze/aspects';
...
export const ARROW_TYPE = MOVABLE_ASPECT | DESTROY_OBJECT_ON_COLLISION_ASPECT | KILL_ON_COLLISION_OBJECT_ASPECT | COLLISION_ASPECT | ARROW_OBJECT_ASPECT;
