...
export const aspects = {
	[ARROW_TYPE]: [ MOVABLE_ASPECT, ROCK_TARGET_ASPECT, COLLISION_ASPECT, ARROW_OBJECT_ASPECT ],
	[PLAYER_TYPE]: [ CONTROLLABLE_ASPECT, ROCK_TARGET_ASPECT, COLLISION_ASPECT, ACTOR_ASPECT, COLLECTOR_ASPECT, ARROW_TARGET_ASPECT, MOVABLE_ASPECT ],
	[ROCK_TYPE]: [ CONTROLLABLE_ASPECT, ROCK_TARGET_ASPECT, ROCK_OBJECT_ASPECT, COLLISION_ASPECT, MOVABLE_ASPECT ],
	[BOX_TYPE]: [ CONTROLLABLE_ASPECT, COLLISION_ASPECT, MOVABLE_ASPECT ],
	[WALL_TYPE]: [ COLLISION_ASPECT ],
	[EXIT_TYPE]: [ EXIT_ASPECT ],
	[KEY_TYPE]: [ COLLECTABLE_ASPECT ],
	[ARROW_CANNON_TYPE]: [ SPAWNER_OBJECT_ASPECT, COLLISION_ASPECT ],
